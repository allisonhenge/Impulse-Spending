...
def compare_data(comparison_df, customer_inputs):
    ...
    if comparison_df == 'Not Hotel Data' or 
        revenue == 'No Current Retail Revenue' or 
        profit_margin == 'Not Currently Profitable' or 
        hotel_group == 'Not Hotel' or hotel_type == 'Not Hotel':
        results = "Our robot could not compare your data to enough similar hotels to be accurate. That just means we get to contact you directly through the email you've provided"
    else:

class_hotel = Hotel(customer_inputs)
class_hotel.
