...
# hotel_to_classify = Hotel(flag_groupings, name, input_brand, input_flag, input_rooms, input_specialty_service, input_occupancy_rate, input_revenue, revenue_period, input_profit, profit_type, profit_period)

# name = name
# brand = Hotel.get_brand()
# flag = input_flag
# num_rooms = input_rooms
# room_range = Hotel.get_room_range()
# size_subset = Hotel.get_size_subset()
# hotel_type = Hotel.hotel_type()
# hotel_group = Hotel.get_group()
# specialty_service = Hotel.is_specialty()
# occupancy_rate = Hotel.get_occupancy_rate()
# revenue = Hotel.get_monthly_revenue()
# profit = Hotel.get_profit_margin()

# classified_hotel = [name, brand, flag, num_rooms, room_range, size_subset, hotel_type, hotel_group, specialty_service, occupancy_rate, revenue, profit]
...
if __name__ == "__main__":
    ...
    # input_list = [flag_groupings, name, input_brand, input_flag, 
